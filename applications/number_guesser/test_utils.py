...
class NumberGuesserTest(TestCase, ABC):
    ...
    def _apply_patches(self):
        with patch(self.path_prefix + 'success') as success_mock, \
                patch(self.path_prefix + 'fail') as fail_mock, \
                patch(self.path_prefix + 'randrange') as randrange_mock, \
                patch(self.path_prefix + 'input') as input_mock:
